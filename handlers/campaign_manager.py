...
from keyboards.campaign_admin_keyboard import (
    ...
    try:
        ...
        for campaign in campaigns:
            ...
            await message.answer(
                ...
                f"💰 {campaign.reward} درهم\n"
                f"📌 {status}",
                reply_markup=campaign_admin_keyboard(
                    campaign.id
                )
            )
